...
@Autonomous
public class Test2 extends CommandOpMode {
    ...
    public void initialize(){
        ...
        follower.setStartingPose(new Pose(56, 8.75, Math.toRadians(135)));
        Paths = new BluePaths(BluePaths.AutoType.TEST2, follower);
        Paths.buildPaths();
