...
public class TurretPIDFController extends Controller {
    protected double kP, kI, kD, kF, kA;
    protected double minIntegral, maxIntegral;
    protected double preErrorValv = 0;
    protected double errorVal_a;
     ...
     */
    public TurretPIDFController(double kp, double ki, double kd, double kf, double ka) {
        this(kp, ki, kd, kf, ka, 0, 0);
    }
     ...
     */
    public TurretPIDFController(double kp, double ki, double kd, double kf, double ka, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
    ...
    protected double calculateOutput(double pv) {
        ...
        if (Math.abs(period) > 1E-6) {
            ...
            errorVal_a = (errorVal_v - preErrorValv) / period;
