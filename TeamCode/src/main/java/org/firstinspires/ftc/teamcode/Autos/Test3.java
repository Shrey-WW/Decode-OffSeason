...
@Autonomous
public class Test3 extends CommandOpMode {
    ...
    public void initialize(){
        ...
        follower.setStartingPose(new Pose(56, 8.75, Math.toRadians(180)));
        Paths = new BluePaths(BluePaths.AutoType.TEST3, follower);
        Paths.buildPaths();
