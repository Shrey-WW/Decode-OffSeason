...
public class RedPaths {
    ...
    public Pose startPose, GPPpose, PGPpose, PPGpose, scorePose, gatePose, Spike1, Spike2, Spike3;

    public PathChain Intake1, goToScore1, Intake2, goToScore2, Intake3, goToScore3, openGate, openGate2, leave;
